      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-left md:text-center mb-16 animate-fade-in">
            <div className="inline-block px-6 py-2 text-white rounded-full text-sm font-bold mb-6 shadow-lg" style={{ background: theme.getPrimaryGradient() }}>
          ...
          <div className="space-y-6">
            <Link href="/menu">
              <Card className="group cursor-pointer transition-all duration-700 hover:shadow-2xl border-0 overflow-hidden relative animate-slide-up bg-white dark:bg-stone-800">
                <div className="absolute inset-0 transform translate-x-full group-hover:translate-x-0 transition-transform duration-700" style={{ background: theme.getPrimaryGradient() }}></div>
                  ...
                  <div className="flex flex-col md:flex-row items-center md:min-h-[280px]">
                    <div className="w-full md:w-1/3 h-48 md:h-[280px] relative overflow-hidden bg-gray-900">
                      {pizzaKebabBg ? (
                        <>
                          ...
                          />
                          <div className="absolute inset-0 z-10" style={{ background: `linear-gradient(to bottom right, ${theme.primary}80, ${theme.secondary}80)` }}></div>
                        </>
                      ) : (
                        <div className="absolute inset-0 z-0" style={{ background: theme.getPrimaryGradient() }}></div>
                      )}
                    ...
                    <div className="flex-1 p-8 md:p-10">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-1 rounded-full" style={{ background: theme.getPrimaryGradient() }}></div>
                        <span className="font-bold text-sm uppercase tracking-wider" style={{ color: theme.primary }}>Featured</span>
                      </div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-3xl font-black text-gray-900 dark:text-white group-hover:text-white transition-colors">
                          {t("Alkaen", "From")} <span style={{ color: theme.primary }} className="group-hover:text-yellow-300">10,40€</span>
                        </div>
            ...
            {config.services.hasLunchBuffet && (
              <Card className="group cursor-pointer transition-all duration-700 hover:shadow-2xl border-0 overflow-hidden relative animate-slide-up bg-white dark:bg-stone-800">
                <div className="absolute inset-0 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-700" style={{ background: theme.getGradient(theme.secondary, theme.accent) }}></div>
                <CardContent className="p-0 relative z-10">
                  <div className="flex flex-col md:flex-row-reverse items-center">
                    <div className="w-full md:w-1/3 h-48 md:h-full relative overflow-hidden">
                      <div className="absolute inset-0 flex items-center justify-center" style={{ background: theme.getGradient(theme.secondary, theme.accent) }}>
                        <Coffee className="w-20 h-20 text-white transform group-hover:-rotate-12 group-hover:scale-110 transition-all duration-500" />
                      </div>
                    </div>
                    <div className="flex-1 p-8 md:p-10">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-1 rounded-full" style={{ background: theme.getGradient(theme.secondary, theme.accent) }}></div>
                        <span className="font-bold text-sm uppercase tracking-wider" style={{ color: theme.secondary }}>Daily Special</span>
                      </div>
                      <h3 className="text-3xl md:text-4xl font-black mb-4 text-gray-900 dark:text-white group-hover:text-white transition-colors">
                      ...
                      <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full group-hover:bg-white transition-colors" style={{ backgroundColor: `${theme.accent}` }}>
                        <Clock className="w-5 h-5" style={{ color: theme.secondary }} />
                        <span className="font-bold" style={{ color: theme.foreground }}>{t("Kysy hinta", "Ask for price")}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <a href="tel:+35837812222">
              <Card className="group cursor-pointer transition-all duration-700 hover:shadow-2xl border-0 overflow-hidden relative animate-slide-up bg-white dark:bg-stone-800">
                <div className="absolute inset-0 transform translate-x-full group-hover:translate-x-0 transition-transform duration-700" style={{ background: theme.getGradient(theme.success) }}></div>
                <CardContent className="p-0 relative z-10">
                  <div className="flex flex-col md:flex-row items-center md:min-h-[280px]">
                    <div className="w-full md:w-1/3 h-48 md:h-[280px] relative overflow-hidden bg-gray-900">
                      {quickOrderBg ? (
                        <>
                          ...
                          />
                          <div className="absolute inset-0 z-10" style={{ background: `linear-gradient(to bottom right, ${theme.success}80, ${theme.success}CC)` }}></div>
                        </>
                      ) : (
                        <div className="absolute inset-0 z-0" style={{ background: theme.getGradient(theme.success) }}></div>
                      )}
                      <div className="absolute inset-0 flex items-center justify-center z-20">
                    ...
                    <div className="flex-1 p-8 md:p-10">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-1 rounded-full" style={{ background: theme.getGradient(theme.success) }}></div>
                        <span className="font-bold text-sm uppercase tracking-wider" style={{ color: theme.success }}>Quick Order</span>
                      </div>
                      <h3 className="text-3xl md:text-4xl font-black mb-4 text-gray-900 dark:text-white group-hover:text-white transition-colors">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="w-12 h-12 rounded-full flex items-center justify-center group-hover:bg-white transition-colors" style={{ backgroundColor: `${theme.success}20` }}>
                          <Phone className="w-6 h-6" style={{ color: theme.success }} />
                        </div>
                      </div>
                    </div>
                  </div>
